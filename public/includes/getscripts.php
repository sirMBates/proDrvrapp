...
function getClockandMainOrNav () {
    ...
    elseif ($url === '/public/views/drvrsignup.php' || $url === '/public/views/complete_signup.php' || $url === '/public/views/drvrsignin.php') {
        return;
    }  
    else {
    ...
    global $url;
        switch($url) {
            case "/public/views/drvrsignup.php":
                echo "<script type='module' src='../assets/js/signup.js'></script>\n";
                break;

            case "/public/views/complete_signup.php":
                echo "<script type='module' src='../assets/js/messagevalidation.js'></script>\n\n";
                echo "<script type='module' src='../assets/js/inputfeedback.js'></script>\n";
                break;

            case "/public/views/drvrsignin.php":
                echo "<script type='module' src='../assets/js/signin.js'></script>\n";
                break;
