...
})({"eXuZ0":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "b7d0404220dae741";
"use strict";
...
var _appmodalJs = require("./appmodal.js");
var _drvrapiJs = require("./drvrapi.js");
var _changestatusJs = require("./changestatus.js");
let isDarkMode;
const infoBtn = document.querySelector('#notifyinfo');
const infoModal = document.querySelector('#info-modal');
const infoModalMsg = (0, _appmodalJs.buildModal);
...
$(document).ready(()=>{
    ...
    infoModal.addEventListener('shown.bs.modal', ()=>{
        if (window.location.pathname === '/') infoModalMsg.info('Welcome to your dashboard. From here, you can update your status (which will automatically notify dispatch) and get brief details about your job(s) (if any assignments assigned to you) for the day. If and when you need to update your status from another page, click the icon in the navigation bar and search for switch status. That is where you\'ll also find other options as well.', 'Ok');
        if (window.location.pathname === '/orders') infoModalMsg.info(`This is where your job orders will be viewed. You\'ll be able to edit certain times, details and add notes for dispatch and your personal reference.<br> You must confirm the job by clicking the button below once received.<br> When you\'re completing the job, click the edit button down below if there are any changes to be made.<br> If no changes, complete the dispatch order.<br> You can also cancel the job if dispatch allows.`, 'Ok');
        if (window.location.pathname === '/profile') infoModalMsg.info('Here on your account info profile, this is where you can view your personal information. You can only update your email, mobile number and password. If you would like to update any of the 3, click the button next to the field you would like to update.', 'Ok');
        if (window.location.pathname === '/timesheet') infoModalMsg.info("This is your timesheet (cha`ching`\uD83D\uDCB0). This sheet will hold a record of each job/order you've done for the week. Once the week is over, a new sheet will be made available for you to utilize. If your payroll dept requests, you may send this sheet to them as is, print it out or download a copy for yourself.", 'Ok');
    });
...
window.addEventListener('DOMContentLoaded', ()=>{
    (0, _drvrapiJs.fetchDrvr)("https://prodriver.local/getprofile").then((data)=>{
        const driver = data;
        const drvrMainMenu = document.querySelector('#useraccess');
        const drvrMainHeader = drvrMainMenu.childNodes[1].childNodes[3];
        if (driver) drvrMainHeader.textContent = `${driver[3]} ${driver[4]}`;
    }).catch((error)=>{
        if (error) {
            const drvrMainMenu = document.querySelector('#useraccess');
            const drvrMainHeader = drvrMainMenu.childNodes[1].childNodes[3];
...
const driverStatus = new (0, _changestatusJs.ChangeStatus)(DSC, statusEndpoint, drvrTokenValue, bannerMsg);
driverStatus.init();
...
window.addEventListener('load', ()=>{
    ...
    if (isActiveEmergency === 'true') emergencyBackground.forEach((background)=>{
        background.classList.remove('bg-besttrailsclr');
        background.classList.add('bg-danger');
    });
});
...
const themeSet = {
    ...
    darkTheme () {
        ...
        if (textbox) $(textbox).removeClass('bg-btd-textarea-clr text-dark');
        isDarkMode = true;
    },
    // Set the Light theme.
    lightTheme () {
        ...
        if (textbox) $(textbox).addClass('bg-btd-textarea-clr text-dark');
        isDarkMode = false;
    },
    setThemeLocally () {
...
window.addEventListener('load', function() {
    ...
    if (currTheme === 'true') themeSet.darkTheme();
    else themeSet.lightTheme();
    return themeSet.setThemeLocally();
});
...
function viewablePayCard() {
    ...
    if (currentView === '/timesheet') viewPayCard.classList.remove('d-none');
    else viewPayCard.classList.add('d-none');
...
$(profileInput).on('change', (e)=>{
    ...
    if (file) {
        ...
        if (file.name === "photo-camera-interface-symbol-for-button.png") profileImage.setAttribute('src', "../../images-videos/logoandicons/photo-camera-interface-symbol-for-button.png");
...
$(logoutLink).on('click', ()=>{
    if (localStorage.getItem('status') !== null) localStorage.removeItem('status');
    if (localStorage.getItem('isActiveEmergency') !== null) localStorage.removeItem('isActiveEmergency');
    if (sessionStorage.getItem('status') !== null) sessionStorage.removeItem('status');
});
if (window.location.pathname !== '/') $(changeStatusCon).removeClass('d-none');
 /*const dropdownElementList = document.querySelectorAll('.dropdown-toggle')
const dropdownList = [...dropdownElementList].map(dropdownToggleEl => new bootstrap.Dropdown(dropdownToggleEl))*/ 
},{"bootstrap":"h36JB","./appmodal.js":"lp8JO","./drvrapi.js":"adiLR","./changestatus.js":"aTvju"}],"h36JB":[function(require,module,exports,__globalThis) {
/*!
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lp8JO":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "buildModal", ()=>buildModal);
const buildModal = {
    _message: null,
    get customMessage () {
        return this.message;
    ...
    warning (message1, btnText) {
        ...
        warnMessage.innerHTML = `<strong>${message1}</strong>`;
        warnModalBtn.textContent = btnText;
    },
    danger (message1, btnText) {
        ...
        dangerMessage.innerHTML = `<strong>${message1}</strong>`;
        dangerModalBtn.textContent = btnText;
    },
    info (message1, btnText) {
        const infoModal = document.querySelector('#info-modal');
        ...
        infoMessage.innerHTML = `<strong>${message1}</strong>`;
        infoModalBtn.textContent = btnText;
    },
    success (message1, btnText) {
        ...
        successMessage.innerHTML = `<strong>${message1}</strong>`;
        successModalBtn.textContent = btnText;
    },
    confirm (message1, btnText, btn2Text) {
        ...
        confirmMessage.innerHTML = `<strong>${message1}</strong>`;
        confirmBtn.textContent = btnText;
        unConfirmBtn.textContent = btn2Text;
    },
    custom (message1, bkgdClr, faClass, iconClr, cusLabelTxt, btnClr, btnText) {
        ...
        customMessage.innerHTML = `<strong>${message1}</strong>`;
        customModalBtn.classList.add(btnClr);
        customModalBtn.textContent = btnText;
    }
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"adiLR":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchDrvr", ()=>fetchDrvr);
async function fetchDrvr(url, options = {}) {
    const response = await fetch(url, options);
    if (!response.ok) throw new Error('Network response was not ok');
    return await response.json();
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aTvju":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ChangeStatus", ()=>ChangeStatus);
var _drvrapi = require("./drvrapi");
class ChangeStatus {
...
},{"./drvrapi":"adiLR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["eXuZ0","8lRBv"], "8lRBv", "parcelRequirea76a", {})
