...
})({"6DnAl":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "9dd68397cab92b65";
"use strict";
...
},{}],"17UhU":[function(require,module,exports,__globalThis) {
...
$(function() {
    $(resetpwd).on('input', ()=>{
        let isValid = (0, _validationJs.Validation).validate($(resetpwd).val(), $(resetpwd).attr('type'));
        if (!isValid) $(resetpwd).addClass('is-invalid');
        else {
    ...
    $(confRespwd).on('input', ()=>{
        let isValid = (0, _validationJs.Validation).validate($(confRespwd).val(), $(confRespwd).attr('type'));
    ...
    $(pwdIcon).on("click", function() {
        if ($(pwdIcon).hasClass("fa-eye")) {
            ...
            if ($(resetpwd).attr("type") === "password") $(resetpwd).attr("type", "text");
        } else {
            $(pwdIcon).removeClass("fa-eye-slash");
            $(pwdIcon).addClass("fa-eye");
            $(resetpwd).attr("type", "password");
            if ($(resetpwd).attr("type") === "text") $(resetpwd).attr("type", "password");
        }
    });
    $(confPwdIcon).on("click", function() {
        if ($(confPwdIcon).hasClass("fa-eye")) {
            ...
            if ($(confRespwd).attr("type") === "password") $(confRespwd).attr("type", "text");
        } else {
            $(confPwdIcon).removeClass("fa-eye-slash");
            $(confPwdIcon).addClass("fa-eye");
            $(confRespwd).attr("type", "password");
            if ($(confRespwd).attr("type") === "text") $(confRespwd).attr("type", "password");
        }
    });
    $(resetBtn).on('submit', ()=>{
...
},{"./validation.js":"1Gxkx","./messagevalidation.js":"k47Vl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1Gxkx":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6DnAl","17UhU"], "17UhU", "parcelRequirea76a", {})
