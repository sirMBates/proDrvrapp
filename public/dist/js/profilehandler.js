...
})({"lgmWm":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "c61e881107670f7e";
"use strict";
...
},{}],"jLgvz":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _validationJs = require("./validation.js");
var _messagevalidationJs = require("./messagevalidation.js");
var _messagevalidationJsDefault = parcelHelpers.interopDefault(_messagevalidationJs);
...
const fetchDriver = (0, _drvrapiJs.fetchDrvr);
window.addEventListener('load', ()=>{
    fetchDriver("https://prodriver.local/getprofile").then((data)=>{
        const driver = data;
        if (driver) {
...
emailChangeBtn.addEventListener('click', ()=>{
    if (drvrEmail.hasAttribute('disabled')) $(drvrEmail).prop('disabled', false);
    else if (drvrEmail.setAttribute('disabled', 'false')) $(drvrEmail).attr('disabled');
});
phoneChangeBtn.addEventListener('click', ()=>{
    if (drvrPhoneNumber.hasAttribute('disabled')) $(drvrPhoneNumber).prop('disabled', false);
    else if (drvrPhoneNumber.setAttribute('disabled', 'false')) $(drvrPhoneNumber).attr('disabled');
});
pwdChangeBtn.addEventListener('click', ()=>{
    if (drvrPsword.hasAttribute('disabled')) $(drvrPsword).prop('disabled', false);
    else if (drvrPsword.setAttribute('disabled', 'false')) $(drvrPsword).attr('disabled');
});
$(drvrFullName).on('input', ()=>{
    let isValid = (0, _validationJs.Validation).validate($(drvrFullName).val(), $(drvrFullName).attr('type'));
    if (!isValid) $(drvrFullName).addClass('is-invalid');
    else {
...
$(drvrEmail).on('input', ()=>{
    let isValid = (0, _validationJs.Validation).validate($(drvrEmail).val(), $(drvrEmail).attr('type'));
    if (!isValid) $(drvrEmail).addClass('is-invalid');
    else {
...
$(drvrBirthDate).on('input', ()=>{
    let isValid = (0, _validationJs.Validation).validate($(drvrBirthDate).val(), $(drvrBirthDate).attr('type'));
    if (!isValid) $(drvrBirthDate).addClass('is-invalid');
    else {
...
$(drvrPhoneNumber).on('input', ()=>{
    let isValid = (0, _validationJs.Validation).validate($(drvrPhoneNumber).val(), $(drvrPhoneNumber).attr('type'));
    if (!isValid) $(drvrPhoneNumber).addClass('is-invalid');
    else {
...
$(drvrUserName).on('input', ()=>{
    let isValid = (0, _validationJs.Validation).validateOnlyUsername($(drvrUserName).val(), $(drvrUserName).attr('type'));
    if (!isValid) $(drvrUserName).addClass('is-invalid');
    else {
...
$(drvrPsword).on('input', ()=>{
    let isValid = (0, _validationJs.Validation).validate($(drvrPsword).val(), $(drvrPsword).attr('type'));
    if (!isValid) $(drvrPsword).addClass('is-invalid');
    else {
...
$(updatePswordBtn).on('submit', ()=>{
    return (0, _messagevalidationJsDefault.default)();
});
$(updateTelEmailBtn).on('submit', ()=>{
    return (0, _messagevalidationJsDefault.default)();
});

},{"./validation.js":"1Gxkx","./messagevalidation.js":"k47Vl","./drvrapi.js":"adiLR","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1Gxkx":[function(require,module,exports,__globalThis) {
...
},{}],"k47Vl":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = (()=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lgmWm","jLgvz"], "jLgvz", "parcelRequirea76a", {})
