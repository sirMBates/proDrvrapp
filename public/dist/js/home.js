...
})({"gZ7y9":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "bebd1fdd25fbb93e";
"use strict";
...
var _celebrationJs = require("./celebration.js");
...
window.addEventListener('load', ()=>{
    ...
    fetchDriver("https://prodriver.local/getprofile", {
        ...
        if (driver) {
            fullname.textContent = `${driver[4]}, ${driver[3]}`;
            drvrId.textContent = driver[0];
        }
    }).catch((error)=>{
        const drvrMainTable = document.querySelector('#dashboard-info');
        const fullname = drvrMainTable.childNodes[3].childNodes[1].childNodes[1];
    ...
    if ($(drvrBirthDate).val() !== '') {
        if (!sessionStorage.getItem('celebrationOccured') && !localStorage.getItem('themePlayedAlready')) {
            ...
            if (bDayMonth === todayMon && bDayDate === todayDate) {
                ...
                (0, _celebrationJs.bdayCelebrationHandler)(celebration);
...
function handleCelebration() {
    ...
    if (timeHour >= 6 && timeHour <= 23) window.addEventListener('load', timeCelebrationHandler, false);
}
handleCelebration();
function removeDrvrGov() {
    ...
    if (currentDate !== checkStamp) localStorage.removeItem('driverName');
}
...
},{"./celebration.js":"7GRjJ","./drvrapi.js":"adiLR"}],"7GRjJ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "bdayCelebrationHandler", ()=>bdayCelebrationHandler);
var _appmodalJs = require("./appmodal.js");
function bdayCelebrationHandler(initialize) {
        ...
        initialize.addConfetti({
            ...
            setTimeout(()=>{
                ...
                celebrateModal.addEventListener('shown.bs.modal', ()=>{
                    (0, _appmodalJs.buildModal).custom("On behalf of ProDriver, wishing you a safe & special happy birthday \uD83C\uDF82 enjoy!", 'bg-btd-celebrate-bkgd-clr', 'fa-cake-candles', 'text-primary', `Hey, ${drvrName}!`, 'btn-primary', 'Thank You');
                });
...
},{"./appmodal.js":"lp8JO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lp8JO":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"adiLR":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gZ7y9","cEl3V"], "cEl3V", "parcelRequirea76a", {})
