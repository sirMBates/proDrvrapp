...
})({"kYxHU":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "27a4dd9e2e5b7641";
"use strict";
...
},{}],"j6ynL":[function(require,module,exports,__globalThis) {
...
$(function() {
    $(fornameInput).on('input', ()=>{
        let isValid = (0, _validation.Validation).validate($(fornameInput).val(), $(fornameInput).attr('type'));
        if (!isValid) {
    ...
    $(surnameInput).on('input', ()=>{
        let isValid = (0, _validation.Validation).validate($(surnameInput).val(), $(surnameInput).attr('type'));
        if (!isValid) {
    ...
    $(mobileNumInput).on('input', ()=>{
        let isValid = (0, _validation.Validation).validate($(mobileNumInput).val(), $(mobileNumInput).attr('type'));
        if (!isValid) {
    ...
    $(birthdateInput).on('input', ()=>{
        let isValid = (0, _validation.Validation).validate($(birthdateInput).val(), $(birthdateInput).attr('type'));
        if (!isValid) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kYxHU","j6ynL"], "j6ynL", "parcelRequirea76a", {})

//# sourceMappingURL=regisprofile.js.map
