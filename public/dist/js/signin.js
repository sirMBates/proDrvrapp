...
})({"4R7JQ":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "fd3a2f544b9ac67b";
"use strict";
...
},{}],"4rUUf":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _validation = require("./validation");
var _messagevalidation = require("./messagevalidation");
var _messagevalidationDefault = parcelHelpers.interopDefault(_messagevalidation);
...
$(function() {
    $(usernameInput).on('input', ()=>{
        let isValid = (0, _validation.Validation).validateOnlyUsername($(usernameInput).val(), $(usernameInput).attr('type'));
    ...
    $(passwordInput).on('input', ()=>{
        let isValid = (0, _validation.Validation).validate($(passwordInput).val(), $(passwordInput).attr('type'));
        if (!isValid) {
    ...
    $(signInBtn).on('submit', ()=>{
        return (0, _messagevalidationDefault.default)();
    });
});
const qString = window.location.search;
const urlParams = new URLSearchParams(qString);
const paramValue = urlParams.get('success');
if (paramValue === 'logged out') setInterval(()=>{
    window.location.href = '/signin';
}, 5000);
const popoverTriggerList = document.querySelectorAll('[data-bs-toggle="popover"]');
const popoverList = [
    ...popoverTriggerList
].map((popoverTriggerEl)=>new bootstrap.Popover(popoverTriggerEl)); //const popover = new bootstrap.Popover('.popover-dismiss', {trigger: 'focus'});

},{"./validation":"1Gxkx","./messagevalidation":"k47Vl","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1Gxkx":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4R7JQ","4rUUf"], "4rUUf", "parcelRequirea76a", {})
