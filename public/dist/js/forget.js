...
})({"7iLHG":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "6b41b3f41d8a91f7";
"use strict";
...
},{}],"3i0VO":[function(require,module,exports,__globalThis) {
...
(()=>{
    $(forgetEmail).on('input', ()=>{
        let isValid = (0, _validationJs.Validation).validate($(forgetEmail).val(), $(forgetEmail).attr('type'));
        if (!isValid) $(forgetEmail).addClass('is-invalid');
        else {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["7iLHG","3i0VO"], "3i0VO", "parcelRequirea76a", {})
