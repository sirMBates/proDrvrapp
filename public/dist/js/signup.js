...
})({"59Quw":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "296774f7bc0fa031";
"use strict";
...
},{}],"kcMzV":[function(require,module,exports,__globalThis) {
...
*/ $(function() {
    $(usernameInput).on('input', ()=>{
        let isValid = (0, _validationJs.Validation).validateOnlyUsername($(usernameInput).val(), $(usernameInput).attr('type'));
        if (!isValid) $(usernameInput).addClass('is-invalid');
        else {
    ...
    $(emailInput).on('input', ()=>{
        let isValid = (0, _validationJs.Validation).validate($(emailInput).val(), $(emailInput).attr('type'));
        if (!isValid) $(emailInput).addClass('is-invalid');
        else {
    ...
    $(passwordInput).on('input', ()=>{
        let isValid = (0, _validationJs.Validation).validate($(passwordInput).val(), $(passwordInput).attr('type'));
        if (!isValid) $(passwordInput).addClass('is-invalid');
        else {
    ...
    $(confPasswordInput).on('input', ()=>{
        let isValid = (0, _validationJs.Validation).validate($(confPasswordInput).val(), $(confPasswordInput).attr('type'));
    ...
    $(pwdIcon).on("click", function() {
        if ($(pwdIcon).hasClass("fa-eye")) {
            ...
            if ($(passwordInput).attr("type") === "text") $(passwordInput).attr("type", "password");
        }
    });
    $(confPwdIcon).on("click", function() {
        if ($(confPwdIcon).hasClass("fa-eye")) {
            ...
            if ($(confPasswordInput).attr("type") === "password") $(confPasswordInput).attr("type", "text");
        } else {
            $(confPwdIcon).removeClass("fa-eye-slash");
            $(confPwdIcon).addClass("fa-eye");
            $(confPasswordInput).attr("type", "password");
            if ($(confPasswordInput).attr("type") === "text") $(confPasswordInput).attr("type", "password");
        }
    });
    $(signUpBtn).on('submit', ()=>{
...
},{"./validation.js":"1Gxkx","./messagevalidation.js":"k47Vl","./appmodal.js":"lp8JO","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1Gxkx":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lp8JO":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["59Quw","kcMzV"], "kcMzV", "parcelRequirea76a", {})
