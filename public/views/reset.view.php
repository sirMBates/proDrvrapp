...
?>
    <main class="w-50 my-5 align-self-center">
        ...
        <form id="resetpswd" action="" method="POST" class="needs-validation" novalidate>
            ...
            <div class="d-flex flex-column justify-content-center mb-3">
                <button type="submit" class="btn btn-primary my-2 p-3" name="reset-pswd">Send email</button>
