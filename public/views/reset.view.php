        ...
        <div class="card mb-auto" style="width: 35rem; margin-top: 5% !important;">
            <form id="resetpw" action="" method="POST" class="needs-validation" novalidate>
                ...
                <div class="card-body p-3 my-3 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="input-group my-1">
                            <input type="password" id="conf-reset-pswd" class="form-control fs-4" name="conf-resetpswd" placeholder="Confirm Password" data-bs-container="body" data-bs-toggle="popover" data-bs-title="Confirm password" data-bs-content="Re-enter password" data-bs-placement="right" data-bs-trigger="focus" required><span class="input-group-text rounded-end" aria-describedby="conf-resetpswd"><i class="fa-solid fa-eye" id="con-pwd-icon"></i></span>
