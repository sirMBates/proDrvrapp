        ...
        <main class="container-fluid d-flex flex-row flex-wrap justify-content-evenly mb-1 p-1">
                <div class="card mb-auto" style="width: 90rem;">
                        ...
                        <div id="check-in-btns" class="btn-group btn-group-sm" role="group" aria-label="Large button group">
                                <button type="button" class="btn btn-outline-dark">Enroute to Garage/Yard</button>
                                <button type="button" class="btn btn-outline-dark">Check-In at Garage/Yard</button>
                                <button type="button" class="btn btn-outline-dark">Enroute to pickup location</button>
                                <button type="button" class="btn btn-outline-dark">Arrived at pickup location</button>
                        </div>
                        </div>
                </div>
        </main>
